...
class App:
    ...
    def _criar_formulario(self, frame):
        ...
        # Competição
        ttk.Label(frame, text="Competição:").grid(row=4, column=0, sticky="w")
        ...
        self.competicao_entry.grid(row=4, column=1, sticky="ew")
        self.competicao_entry.bind("<Button-3>", lambda e: self.mostrar_menu_contexto(e, "competicoes"))

        # Gols Vasco
        ttk.Label(frame, text="Gols do Vasco:").grid(row=5, column=0, sticky="nw")
        ...
        self.entry_gol_vasco.grid(row=5, column=1, sticky="ew")
        ...
        self.lista_gols_vasco.grid(row=6, column=1, sticky="ew")
        self.lista_gols_vasco.bind("<Delete>", self.remover_gol_vasco)

        # Gols adversário
        ttk.Label(frame, text="Gols do Adversário:").grid(row=7, column=0, sticky="nw")
        ...
        self.entry_gol_contra.grid(row=7, column=1, sticky="ew")
        ...
        self.lista_gols_contra.grid(row=8, column=1, sticky="ew")
        self.lista_gols_contra.bind("<Delete>", self.remover_gol_contra)

        # Gols ANULADOS do Vasco
        ttk.Label(frame, text="Gols do Vasco Anulados (VAR):").grid(row=9, column=0, sticky="nw")
        ...
        self.entry_anulado_vasco.grid(row=9, column=1, sticky="ew")
        self.lista_anulados_vasco = tk.Listbox(frame, height=2)
        self.lista_anulados_vasco.grid(row=10, column=1, sticky="ew")
        ...
        ttk.Label(frame, text="Gols do Adversário Anulados (VAR):").grid(row=11, column=0, sticky="nw")
        ...
        self.entry_anulado_contra.grid(row=11, column=1, sticky="ew")
        self.lista_anulados_contra = tk.Listbox(frame, height=2)
        self.lista_anulados_contra.grid(row=12, column=1, sticky="ew")
        ...
        self.btn_salvar.grid(row=13, column=0, columnspan=2, pady=10)
